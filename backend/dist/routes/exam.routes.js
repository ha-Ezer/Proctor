 ...
 */
router.get('/active', auth_middleware_1.authenticateToken, auth_middleware_1.requireStudent, examController.getActiveExam);
/**
 * @route   GET /api/exams/:examId
 * @desc    Get specific exam by ID
 * @access  Protected (Admin)
 */
router.get('/:examId', auth_middleware_1.authenticateToken, auth_middleware_1.requireAdmin, examController.getExamById);
